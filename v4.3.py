    ...
    async def on_message(self, message):
        ...
        if game["type"] == "blackjack":
            ...
            if dealer_value > 21 or player_value > dealer_value:
                ...
                description = f"You won {bet_amount:,} coins."
            ...
            if step == 2:
                ...
                if not correct:
                    ...
                    await message.channel.send(embed=result_embed(
                        ...
                        f"You guessed **{content}**. The second card was **{format_card(card2)}**.",
                        format_cards(cards),
                        reward=reward
                    ))
                    return
            ...
            if step == 3:
                ...
                if not correct:
                    ...
                    await message.channel.send(embed=result_embed(
                        ...
                        f"You guessed **{content}**. The third card was **{format_card(card3)}**.",
                        format_cards(cards),
                        reward=reward
                    ))
                    return
            ...
            if step == 4:
                ...
                if card4[1] != suit_words[content]:
                    ...
                    await message.channel.send(embed=result_embed(
                        ...
                        f"You guessed **{content}**. The final card was **{format_card(card4)}**.",
                        format_cards(cards),
                        reward=reward
                    ))
                    return
